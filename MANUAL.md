...
Add a reference to `UnrealEngine.Framework.dll` assembly located in `Source/Managed/Framework/bin/Release` folder. Ideally, add your path to UnrealCLR as an environment variable, and then refer to it in your project.
